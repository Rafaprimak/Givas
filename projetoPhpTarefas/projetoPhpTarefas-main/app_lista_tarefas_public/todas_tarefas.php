...
<nav class="navbar navbar-light bg-light">
    <div class="container">
        ...
        <button class="btn btn-primary" onclick="location.href='todas_tarefas.php?acao=ordenarData'">Ordenar por Data</button>
        <button class="btn btn-primary" onclick="location.href='todas_tarefas.php?acao=ordenarPrioridade'">Ordenar por Prioridade</button>
        <button class="btn btn-primary" onclick="location.href='todas_tarefas.php?acao=ordenarAlfabetica'">Ordenar Alfabeticamente</button>
    </div>
</nav>
